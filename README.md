...
1. Clone the `taco-simulate-server` git repository (`git clone https://github.com/microsoft/taco-simulate-server.git`), as it contains useful example code (see `src/plugins`).
